...
local 		version 		= 	get_plugin_option_value("Clickable-FC3Eagle", "Version", "local")
...
local 		cdata				= 	{
			...
			title				= 	"[ Clickable FC3 Eagle "..version.." ]",
			yes					= 	"OK",
			picture				= 	Picture.new(get_dcs_plugin_path("Clickable-FC3Eagle").."\\Skins\\icon 76x76.png"),
									}
