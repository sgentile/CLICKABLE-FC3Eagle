...
local 		version 		= 	get_plugin_option_value("ClickableF15CMod", "Version", "local")
...
local 		cdata				= 	{
			...
			title				= 	"[ Clickable F15C Mod "..version.." ]",
			yes					= 	"OK",
			picture				= 	Picture.new(get_dcs_plugin_path("ClickableF15CMod").."\\Skins\\icon 76x76.png"),
									}
