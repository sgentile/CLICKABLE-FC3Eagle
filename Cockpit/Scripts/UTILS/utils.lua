...
local entry = get_dcs_plugin_path("ClickableF15CMod").."\\entry.lua"
...
check_entry_version()
optionsEditor.setOption("plugins.ClickableF15CMod.Version",version)
dev_install()
function post_initialize()
		TIMER = 20
		print_message_to_user("[ Clickable F15C Mod ] \n[ "..version.." ]\n[ " .. aircraft .." ]",10)
end
