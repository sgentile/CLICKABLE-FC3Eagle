...
--------------------------------------------------------------------
--  Mainpanel param for taxi light sync
...
--------------------------------------------------------------------------------------------------------
    ...
    if birth=="GROUND_HOT" or birth=="AIR_HOT" then
        -- Hot start: anti-collision on, position lights at intensity 5
        LIGHT_ANTICOL       =   1
        c_flash_stat        =   1
        c_flash             =   c_flash_s
        LIGHT_POS           =   5
        n_flash_stat        =   0
        LIGHT_FORM          =   0
        set_aircraft_draw_argument_value(190, 0.5)  --navl
        set_aircraft_draw_argument_value(191, 0.5)  --navr
        set_aircraft_draw_argument_value(192, 0.5)  --strob
